  ...
  <div class="about-section">
    <div class="about-us">
      <div class="col-md-7 about-left">
        ...
        <div class="abt_image">
          <img src="{{url('frontend/images/abt_pic.jpg')}}" alt="" />
        </div>
    ...
    <div class="team">
      ...
      <div class="team-grids">
        <div class="col-md-2 team-grid">
          ...
          <h5>
          Mark Johnson</h4>
          <p>Ses praesentiumvolup tatum delenitimosem atqcorrupti quos dolo res et quas moles.</p>
        </div>
        <div class="col-md-2 team-grid">
        ...
        <div class="col-md-2 team-grid">
          <img src="{{url('frontend/images/t5.jpg')}}" alt="" />
          <h5>
          John McCoist</h4>
          <p>Ses praesentiumvolup tatum delenitimosem atqcorrupti quos dolo res et quas moles.</p>
        </div>
        <div class="col-md-2 team-grid">
          <img src="{{url('frontend/images/t6.jpg')}}" alt="" />
          <h5>
          Linda Smith</h4>
          <p>Ses praesentiumvolup tatum delenitimosem atqcorrupti quos dolo res et quas moles.</p>
        </div>
