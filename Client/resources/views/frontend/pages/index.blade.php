    ...
    <div class="slider">
      ...
      <div class="conference-slider">
        ...
        <ul class="conference-rslide" id="conference-slider">
          <li><img src="{{url('frontend/images/c22.jpg')}}" alt=""></li>
          <li><img src="{{url('frontend/images/c1.jpg')}}" alt=""></li>
          <li><img src="{{url('frontend/images/c33.jpg')}}" alt=""></li>
          <li><img src="{{url('frontend/images/c44.jpg')}}" alt=""></li>
        </ul>
        <!-- Slideshow 3 Pager -->
        <ul id="slider3-pager">
          <li><a href="#"><img src="{{url('frontend/images/c22.jpg')}}" alt=""></a></li>
          <li><a href="#"><img src="{{url('frontend/images/c1.jpg')}}" alt=""></a></li>
          <li><a href="#"><img src="{{url('frontend/images/c33.jpg')}}" alt=""></a></li>
          <li><a href="#"><img src="{{url('frontend/images/c44.jpg')}}" alt=""></a></li>
        </ul>
    ...
    <div class="posts">
      ...
      <div class="right-posts">
        ...
        <div class="editorial">
          <h3>editorial</h3>
          <div class="editor">
            <a href="single.html"><img src="{{url('frontend/images/e1.jpg')}}" alt="" /></a>
            <a href="single.html">Lorem ipsum dolor sit amet con se cte tur adipiscing elit</a>
          </div>
          <div class="editor">
            <a href="single.html"><img src="{{url('frontend/images/e2.jpg')}}" alt="" /></a>
            <a href="single.html">Lorem ipsum dolor sit amet con se cte tur adipiscing elit</a>
          </div>
          <div class="editor">
            <a href="single.html"><img src="{{url('frontend/images/e1.jpg')}}" alt="" /></a>
          ...
          <div class="editor">
            <a href="single.html"><img src="{{url('frontend/images/e3.jpg')}}" alt="" /></a>
            <a href="single.html">Lorem ipsum dolor sit amet con se cte tur adipiscing elit</a>
          </div>
        </div>
      </div>
