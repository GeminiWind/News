  ...
  <div class="col-md-9 total-news">
      ...
      <div class="tech-main">
        <div class="col-md-4 tech">
          <div class="view view-tenth">
            <a href="singlepage.html"><img src="{{url('frontend/images/book1.jpg')}}" alt="" /></a>
            <div class="mask" >
              <p>A bespoke keepsake to commemorate their first year of marriage</p>
        ...
        <div class="col-md-4 tech">
          <div class="view view-tenth">
            <a href="singlepage.html"><img src="{{url('frontend/images/book2.jpg')}}" alt="" /></a>
            <div class="mask" >
              <p>A bespoke keepsake to commemorate their first year of marriage</p>
              <h5>Continue reading...</h5>
            </div>
        ...
        <div class="col-md-4 tech">
          <div class="view view-tenth">
            <a href="singlepage.html"><img src="{{url('frontend/images/book3.jpg')}}" alt="" /></a>
            <div class="mask" >
              <p>A bespoke keepsake to commemorate their first year of marriage</p>
              <h5>Continue reading...</h5>
            </div>
    ...
    <div class="technology">
      <div class="tech-main">
        <div class="col-md-4 tech">
          <div class="view view-tenth">
            <a href="singlepage.html"><img src="{{url('frontend/images/book4.jpg')}}" alt="" /></a>
            <div class="mask" >
              <p>A bespoke keepsake to commemorate their first year of marriage</p>
              <h5>Continue reading...</h5>
            </div>
        ...
        <div class="col-md-4 tech">
          <div class="view view-tenth">
            <a href="singlepage.html"><img src="{{url('frontend/images/book5.jpg')}}" alt="" /></a>
            <div class="mask" >
              <p>A bespoke keepsake to commemorate their first year of marriage</p>
              <h5>Continue reading...</h5>
            </div>
        ...
        <div class="col-md-4 tech">
          <div class="view view-tenth">
            <a href="singlepage.html"><img src="{{url('frontend/images/book6.jpg')}}" alt="" /></a>
            <div class="mask" >
              <p>A bespoke keepsake to commemorate their first year of marriage</p>
              <h5>Continue reading...</h5>
            </div>
